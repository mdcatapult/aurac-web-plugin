...
export class BackgroundComponent {
  ...
  // private saveURLToEntityMapper(dictionary: Recogniser, entities: Array<LeadminerEntity>): void {
  ...
  //         this.entityCache.get(currentURL) : new Map<Recogniser, Array<LeadminerEntity>>()
  ...
  // private refreshHighlights(dictionary: Recogniser): void {
  //   Promise.all([
  //     this.browserService.getActiveTab(),
  ...
  // private nerCurrentPage(dictionary: Recogniser): void {
  ...
  //       const leadmineURL = `${this.settingsService.APIURLs.nerURL}${environment.production ? `/${dictionaryPath}` : ''}/entities`;
