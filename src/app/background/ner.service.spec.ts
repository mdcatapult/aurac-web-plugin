...
describe('NerService', () => {
  ...
  it('should create an entity from an API response entity', () => {
    const recognisedEntity: APIEntity = {
      ...
      metadata:
        ''
    }
    const entity: Entity = {
